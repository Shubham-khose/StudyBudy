...
public class NavController {
	...
	public String validateStudent(@RequestParam("mail") String email, @RequestParam("pass") String password, Model model,
			HttpSession session) {
		// System.out.println(email + " " + password);
		String message = "Wrong id and Password";

		long i = doubtDao.validateStudent(email, password);
	...
	public String updateCourceByAdmin(AllCourses object, BindingResult br,
			jakarta.servlet.http.HttpServletRequest request, HttpSession session,
			@RequestParam("cName") String cName, @RequestParam("cDescription") String cDescription,
			@RequestParam("cPost") String cPost,
			@RequestParam("cInstructor") String cInstructor, @RequestParam("cExperience") String cExperience,
			@RequestParam("instructorInfo") String instructorInfo,
